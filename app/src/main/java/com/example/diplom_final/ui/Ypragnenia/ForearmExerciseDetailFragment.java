...
import com.example.diplom_final.databinding.FragmentForearmExerciseDetailBinding;

import java.util.ArrayList;

public class ForearmExerciseDetailFragment extends Fragment {
    private FragmentForearmExerciseDetailBinding binding;

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentForearmExerciseDetailBinding.inflate(inflater, container, false);
