...
import com.example.diplom_final.databinding.FragmentButtExerciseDetailBinding;

import java.util.ArrayList;
import java.util.List;

public class ButtExerciseDetailFragment extends Fragment {
    private FragmentButtExerciseDetailBinding binding;

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentButtExerciseDetailBinding.inflate(inflater, container, false);
